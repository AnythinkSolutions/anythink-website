...
export default function Header() {
  return (
    <Grid container rowSpacing={{lg: 0, xs: 1}}>
      <Grid item sm={4} xs={12} container alignItems="start" justifyContent={{md: "flex-start", xs: "center"}} display={{sm: "unset", xs: "none"}}>
      ...
      <Grid item sm={4} xs={12} container alignItems="start" justifyContent={{md: "flex-end", xs: "center"}} order={{sm: 3, xs: 2}} display={{sm: "flex", xs: "none"}}>
        <Stack direction="row" spacing={3}>
